...
namespace SAE.CommonLibrary.ObjectMapper.Bindings
{
    internal sealed class BindingConfigOf<TSource, TTarget> : BindingConfig, IBindingConfig<TSource, TTarget>
    {
        ...
        public ICollection<KeyValuePair<Expression<Func<TSource, object>>, Expression<Func<TTarget, object>>>> BindExpression
        {
            get;
        } = new List<KeyValuePair<Expression<Func<TSource, object>>, Expression<Func<TTarget, object>>>>();
        ...
        public void Bind(Expression<Func<TSource, object>> source, Expression<Func<TTarget, object>> target)
        {
            ...
            this.BindExpression.Add(new KeyValuePair<Expression<Func<TSource, object>>, Expression<Func<TTarget, object>>>(source, target));
        }
