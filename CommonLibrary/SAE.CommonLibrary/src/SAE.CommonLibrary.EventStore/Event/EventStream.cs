...
namespace SAE.CommonLibrary.EventStore
{
    ...
    public class EventStream:IEnumerable<IEvent>
    {
        ...
        public EventStream(IIdentity identity,long version,string eventJsons,DateTimeOffset dateTime):this(identity,version, Enumerable.Empty<IEvent>(),dateTime)
        {
        ...
        public EventStream(IIdentity identity, long version, IEnumerable<IEvent> events):this(identity,version,events,DateTimeOffset.Now)
        {
        }
        ...
        public EventStream(IIdentity identity, long version, IEnumerable<IEvent> events,DateTimeOffset timeStamp)
        {
